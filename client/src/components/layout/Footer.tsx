    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About AADF */}
          <div>
            <h3 className="text-lg font-semibold mb-4">About AADF</h3>
            <p className="text-gray-300 text-sm">
              The Agricultural Agency for Development and Finance promotes agricultural
              development through transparent procurement processes.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/tenders" className="text-gray-300 hover:text-white">
                  Tenders
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              <li className="flex items-center">
                ...
                P.O. Box 1234, Kigali, Rwanda
              </li>
              <li className="flex items-center">
                <span className="material-icons text-base mr-2">phone</span>
                +250 123 456 789
              </li>
              <li className="flex items-center">
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} AADF Procurement Platform. All rights reserved.
            </p>
