# Generated by Django 5.1.6 on 2025-05-01 08:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uploaded_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='aadf.user')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='tender',
            name='created_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_tenders', to='aadf.user'),
        ),
        migrations.CreateModel(
            name='Report',
            fields=[
                ...
                ('generated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='aadf.user')),
            ],
            options={
                'db_table': 'reports',
                'ordering': ['-created_at'],
        ...
        migrations.AddField(
            model_name='offer',
            name='submitted_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='aadf.user'),
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notifications', to='aadf.user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='audit_logs', to='aadf.user')),
            ],
            options={
                'db_table': 'audit_logs',
                'ordering': ['-created_at'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='approvals', to='aadf.user')),
            ],
            options={
                'db_table': 'approvals',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aadf.user')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='users',
            field=models.ManyToManyField(related_name='vendor_companies', through='aadf.VendorUser', to='aadf.user'),
        ),
        migrations.CreateModel(
            name='Evaluation',
            fields=[
                ...
                ('evaluator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='evaluations', to='aadf.user')),
            ],
            options={
